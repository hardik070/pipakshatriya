...
//
//       if (user != null) {
//         if(isSignInMode == true)
//           {
//             String uniqueId = emailController.text.split('@')[0];
//             fetchDocumentData(uniqueId);
//           }else{
//             String uniqueId = emailController.text.split('@')[0];
//             storeDoc(uniqueId);
//           }
...
//       isLoading = false;
//     });
//     print('andu gandu code : $errorCode');
//     switch (errorCode) {
//       case 'user-not-found':
...
//   }
//
//   Future<void> storeDoc(String uniqueId) async {
//     //String uniqueId = emailController.text.split('@')[0];
//
...
//     GlobalVariables().email = emailController.text;
//     GlobalVariables().number = '';
//     GlobalVariables().course = '';
//     GlobalVariables().institute = '';
//     GlobalVariables().goal = '';
//     GlobalVariables().userid = uniqueId;
...
//   }
//
//   Future<void> fetchDocumentData(String uniqueid) async {
//
//     try {
...
//
//         GlobalVariables().name = data['name'] ?? '';
//         GlobalVariables().email = data['email'] ?? '';
//         GlobalVariables().number = data['number'] ?? '';
//         GlobalVariables().course = data['course'] ?? '';
//         GlobalVariables().institute = data['institute'] ?? '';
//         GlobalVariables().goal = data['goal'] ?? '';
//         GlobalVariables().userid = data['userid'] ?? '';
//         GlobalVariables().city = data['city'] ?? '';
//         GlobalVariables().gender = data['gender'] ?? false;
//         GlobalVariables().saveData();
//
//         Navigator.pushAndRemoveUntil(
//           context,

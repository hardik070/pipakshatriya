...
//             double start = 0;
//             List<String> reversedList = graph.reversed.toList();
//             graph.clear();
//             graph = reversedList;
...
//                         if(entry.value != "End"){
//                           if(drawIndex%2 != 0){
//                             if(!codinates.containsKey(graph[drawIndex+1])){
//                               // return CustomPaint(
//                               //   painter: ArrowPainter(
//                               //       from: Offset(start, fromTop),
...
//                               //       labelStyle: TextStyle(color: getRandomColor(), fontWeight: FontWeight.w500, fontSize: 7),
//                               //       arrowColor: Color(0xffb847ff).withOpacity(0.8),
//                               //       // glassColor: Color(0xffb847ff).withOpacity(1),
...
//                               return Positioned(top: fromTop, left: fromLeft, child: RelationCard(title: graph[drawIndex]));
//                             }
//
//                           }
//                         }else{
...
//                                     fontSize: 8,
//                                   ),
//                                   arrowColor: Color(0xffb847ff).withOpacity(0.5),
//                                   glassColor: getRandomColor().withOpacity(0.4),
//                                   lineColor: getRandomColor().withOpacity(0.7),
//                                 ),
//                               );
//                             } else {
//                               // Debugging
...
//   final String title;
//
//   const RelationCard({required this.title});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//           ],
//         ),
//         child: Center(child: Text(title, style: TextStyle(fontSize: 5)))
//     );
//   }
// }
import 'package:flutter/material.dart';
